...
<form class="form-horizontal" role="form" action="Give">
    <div class="form-group">
    <label for="lastname" class="col-sm-2 control-label">请输入转账账户</label>
    <div class="col-sm-10">
        <input type="text" class="form-control" id="second" name="zzcount" placeholder="转账账户" style="width: 150px;">
    </div>
    </div>
    <div class="form-group">
        <label for="firstname" class="col-sm-2 control-label">请输入转账金额</label>
        <div class="col-sm-10">
            <input type="text" class="form-control" id="firstname"  name="amount" placeholder="转账金额" style="width: 150px;">
        </div>
